...
public class SirishaRanga_TC13_VerifyDatePickerEnabled  {
	
WebDriver driver;
	
	@Test()
	public void sirisharanga_TC13_VerifyDatePickerEnabled() throws InterruptedException, IOException {
	...
	public void selectDesiredDate(String date) {
        ...
        for(int i=1;i<=totalrows;i++) {
        	for(int j=1;j<=totalcols;j++) {
        		String alldates=driver.findElement(By.xpath("//table/tbody/tr["+i+"]/td["+j+"]")).getText();
